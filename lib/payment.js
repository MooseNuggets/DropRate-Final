...
// A unique correlation id for one payment. On Solana this maps to a Solana-Pay
// `reference` pubkey the client attaches to the transfer; here it's an opaque
// 32-byte id the edge converts. Unguessable so nobody can hijack a pull's quote.
